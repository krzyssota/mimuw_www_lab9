...
var db = DatabaseHandler_1.make_db();
exports.mostExpensive.forEach(function (m) { return __awaiter(void 0, void 0, void 0, function () {
    var meme, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                meme = new Meme_1.Meme(m.id, m.name, m.url);
                meme.addPrice(m.price, 'admin');
                return [4 /*yield*/, exports.mList.addMeme(db, meme)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
